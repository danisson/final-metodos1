...
all: bin/teste.o bin/funcoesReais.o bin/polinomios.o bin/exponencial.o
	$(CC) $(CFLAGS) -o bin/teste bin/teste.o bin/funcoesReais.o bin/polinomios.o bin/exponencial.o
